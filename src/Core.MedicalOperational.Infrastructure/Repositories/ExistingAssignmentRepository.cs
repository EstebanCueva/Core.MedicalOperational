...
public class ExistingAssignmentRepository : EfRepository<ExistingAssignment>, IExistingAssignmentRepository
{
    public ExistingAssignmentRepository(MedicalOperationalDbContext context) : base(context)
    {
    }
}
