...
public class DoctorScheduleAvailabilityRule : IAppointmentAvailabilityRule
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            if (assignment.DoctorId != candidate.Doctor.Id || assignment.Status != AssignmentStatus.Active)
            {
                continue;
            }
